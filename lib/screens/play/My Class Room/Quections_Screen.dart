...
class QuectionScreen extends StatefulWidget {
  const QuectionScreen({Key key}) : super(key: key);

  @override
  State<QuectionScreen> createState() => _QuectionScreenState();
}

class _QuectionScreenState extends State<QuectionScreen> {
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
              image: AssetImage('assets/bg/quection.png'),
              fit: BoxFit.fill,
            ),
          ),
        ),
