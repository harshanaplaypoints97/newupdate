...
import 'Rest WinnerNewFeedCard.dart';

class RestWinnerFeedContainer extends StatelessWidget {
  const RestWinnerFeedContainer({Key key}) : super(key: key);
